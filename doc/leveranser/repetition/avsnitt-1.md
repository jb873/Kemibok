...
**Sökväg:** `delkapitel/repetition/avsnitt-1-atomer-molekyler-joner.html`
**AVSNITT_ID:** `a1_atomer-molekyler-joner`
**Underrubrik i hero:** materiens minsta byggstenar

> Återskapad 2026-09-13 ur den byggda sidan (det byggda är sanningen; chattleveransen 2026-09-12
...
### `atommodell-litium.webp` — underdel A, Enkel + Standard

**Alt-text:** Modell av en litiumatom. I mitten en liten kärna med tre röda protoner märkta med plus och fyra grå neutroner utan tecken. Runt kärnan två banor med blå elektroner märkta med minus — två på den inre banan och en på den yttre. Kärnan är mycket liten jämfört med atomen som helhet.

**Bildtext Enkel:** En litiumatom. Kärnan i mitten innehåller protoner och neutroner. Elektronerna finns runt omkring.

**Bildtext Standard:** Litiumatomen har tre protoner och fyra neutroner i kärnan, och tre elektroner runt den. Lägg märke till hur liten kärnan är — nästan hela atomen är tom.

### `attrahera-repellera.webp` — underdel A, Enkel + Standard

**Alt-text:** Två halvor. Till vänster två positiva laddningar långt ifrån varandra, med pilar som pekar bort från varandra. Till höger en positiv och en negativ laddning tätt intill varandra, med pilar som pekar mot varandra.

**Bildtext Enkel:** Lika laddningar stöter bort varandra. Olika laddningar dras ihop.

**Bildtext Standard:** Två laddningar med samma tecken repellerar varandra. Två med olika tecken attraherar varandra. Regeln gäller lika för protoner, elektroner och joner.

### `grundamne-forening.webp` — underdel B, Enkel + Standard

**Alt-text:** Till vänster en syremolekyl, två lika stora röda syreatomer sammanbundna. Till höger en vattenmolekyl, en röd syreatom med två mindre vita väteatomer i en vinkel.

**Bildtext Enkel:** Till vänster O₂ — två atomer, men bara en sort. Till höger H₂O — tre atomer och två olika sorter.

**Bildtext Standard:** Syremolekylen består av två atomer av samma slag och är därför ett grundämne. Vattenmolekylen innehåller två olika atomslag och är en kemisk förening. Det är antalet olika atomslag som avgör, inte antalet atomer.

### `litium-atom-och-jon.webp` — underdel C, Enkel + Standard

**Alt-text:** Två atommodeller sida vid sida. Till vänster en litiumatom med tre elektroner — två på den inre banan och en på den yttre. Till höger en litiumjon med samma kärna men bara två elektroner; den yttre banan är tom.

**Bildtext Enkel:** Samma atom, före och efter. Kärnan är oförändrad — det är bara en elektron som försvunnit.

**Bildtext Standard:** När litiumatomen avger sin yttersta elektron blir den en litiumjon, Li⁺. Antalet protoner är detsamma, så det är fortfarande litium — men nu med en positiv laddning.
...
# UNDERDEL B — Molekyler och ämnen
...
En syremolekyl består av två syreatomer, och den skrivs O₂. En vattenmolekyl består av två väteatomer och en syreatom, och den skrivs H₂O. En koldioxidmolekyl består av en kolatom och två syreatomer, och den skrivs CO₂.

### Vad siffrorna betyder

De små siffrorna i en formel talar om hur många atomer av varje sort som finns i molekylen.

Titta på H₂O. Tvåan står efter H och betyder att det finns två väteatomer. Efter O står ingen siffra alls, och det betyder att det bara finns en syreatom. Skriver man ingen siffra menas alltid en.

Samma sak i CO₂: en kolatom, och tvåan efter O betyder två syreatomer.
...
Syre är ett grundämne. I luften finns syre som molekyler med två syreatomer, O₂, men båda atomerna är syreatomer — det är fortfarande bara en sort. Molekylen består av flera atomer, men ämnet är ändå ett grundämne.

Det är en sak som är lätt att blanda ihop. Antalet atomer spelar ingen roll. Det är antalet **sorter** som avgör.

Väte och kväve fungerar likadant. Väte finns som H₂ och kväve som N₂, och båda är grundämnen eftersom det bara finns en sorts atom i varje molekyl.
...
Vatten är en kemisk förening. En vattenmolekyl, H₂O, innehåller både väteatomer och syreatomer — två olika sorter. Koldioxid, CO₂, är också en kemisk förening, eftersom den innehåller både kol och syre.
...
O₂ har två atomer men en sort, alltså grundämne. H₂O har tre atomer och två sorter, alltså kemisk förening.
...
En syremolekyl består av två syreatomer och skrivs O₂. En vattenmolekyl består av två väteatomer och en syreatom och skrivs H₂O. En koldioxidmolekyl består av en kolatom och två syreatomer och skrivs CO₂.

De små siffrorna i en kemisk formel visar hur många atomer av ett visst atomslag som finns i molekylen. I H₂O visar tvåan att molekylen innehåller två väteatomer. Eftersom det inte står någon siffra efter O finns det bara en syreatom.
...
Syre är ett grundämne eftersom det bara innehåller syreatomer. I luften finns syret framför allt som molekyler med två syreatomer, O₂. Trots att varje syremolekyl består av två atomer är syre fortfarande ett grundämne — båda atomerna tillhör samma atomslag.

Även väte och kväve förekommer som molekyler: H₂ är väte och N₂ är kväve. Båda är grundämnen, eftersom molekylerna bara innehåller ett atomslag.
...
Vatten, H₂O, är en kemisk förening eftersom varje vattenmolekyl innehåller både väteatomer och syreatomer. Koldioxid, CO₂, är också en kemisk förening, eftersom molekylen innehåller både kolatomer och syreatomer.
...
Standardtexten konstaterade att syre i luften finns som O₂, väte som H₂ och kväve som N₂. Men den sa aldrig varför. Varför går just dessa atomer ihop parvis i stället för att flyta omkring en och en?
...
En ensam syreatom har sex valenselektroner. Den saknar två för att nå åtta. Två syreatomer kan lösa det tillsammans genom att dela på elektroner: varje atom bidrar med två, och båda får räkna de delade elektronerna som sina egna. Resultatet är att båda atomerna når åtta, och molekylen O₂ är stabilare än två lösa syreatomer.

Väte fungerar likadant men med andra tal. Väteatomen har bara en elektron och behöver två för att fylla sitt första skal — som är litet och rymmer just två. Två väteatomer delar på sina elektroner och når båda målet. Därför H₂.

Kväve är det tydligaste fallet. Kväveatomen har fem valenselektroner och saknar tre. Två kväveatomer måste därför dela på hela tre elektronpar för att båda ska nå åtta. Det gör bindningen i N₂ ovanligt stark — så stark att kvävgas är nästan oreaktiv, trots att kväve som ämne ingår i allt levande. Att få kväve att reagera kräver mycket energi, och det är därför konstgödsel är energikrävande att tillverka.
...
Atomen har blivit en **jon**, och den har en positiv laddning. Vi skriver den Li⁺. Det lilla plustecknet visar att laddningen är positiv.
...
En jon som har **fler** elektroner än protoner blir **negativ**. Då finns det fler minus än plus. En kloridjon skrivs Cl⁻, och minustecknet visar att laddningen är negativ. En negativ jon kallas också anjon.
...
Hydroxidjonen är ett exempel. Den skrivs OH⁻ och består av en syreatom och en väteatom, och tillsammans har de en negativ laddning.

Andra exempel är nitratjonen, NO₃⁻, och sulfatjonen, SO₄²⁻.

I SO₄²⁻ står det en tvåa framför minustecknet. Den betyder att hela jonen har två negativa laddningar, inte bara en.
...
Om en atom har färre elektroner än protoner finns det ett överskott av positiv laddning. Atomen har då blivit en **positiv jon**, som också kallas katjon. En litiumjon skrivs Li⁺. Plustecknet visar att partikeln har en positiv laddning.

Om en atom i stället har fler elektroner än protoner finns det ett överskott av negativ laddning. Då har den blivit en **negativ jon**, som också kallas anjon. En kloridjon skrivs Cl⁻. Minustecknet visar att laddningen är negativ.
...
Hydroxidjonen, OH⁻, består av en syreatom och en väteatom och har en negativ laddning. Andra exempel är nitratjonen, NO₃⁻, och sulfatjonen, SO₄²⁻.

Tvåan i SO₄²⁻ visar att hela jonen har två negativa laddningar.
...
I standardtexten fick du veta att en litiumatom kan bli Li⁺ och en kloratom kan bli Cl⁻. Men varför blir det just så? Varför tappar inte klor en elektron i stället, eller litium tar upp en?
...
## FAKTARUTA (underdel A, nivåer: enkel, standard)

**Rubrik:** Attrahera och repellera

**Attrahera** betyder dra till sig. Två laddningar med olika tecken — en positiv och en negativ — attraherar varandra.

**Repellera** betyder stöta bort. Två laddningar med samma tecken attraherar inte varandra, utan repellerar.

Orden säger något om kraftens **riktning**, inte om hur stark den är. Hur stark kraften blir beror bland annat på hur stora laddningarna är och hur nära varandra de befinner sig.

**Sammanfattning:**
- Attrahera = olika laddning, dras ihop
- Repellera = lika laddning, stöts isär
